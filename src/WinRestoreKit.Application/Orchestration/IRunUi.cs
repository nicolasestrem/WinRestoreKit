...
namespace WinRestoreKit
{
    ...
    /// <c>ConfPageView</c> without taking control references with it. Every member is a direct
    /// replacement for something the view used to do inline; see the per-member remarks for the
    /// exact line each replaces. The orchestrator is app-side because it coordinates UI work
    /// through this neutral contract.
    /// </remarks>
